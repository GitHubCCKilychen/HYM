...
- (void)openConnector:(NSMutableURLRequest*)request
{
    ...
    {
        NSDictionary *dic=[NSDictionary dictionaryWithObjects:[NSArray arrayWithObjects:@"1",@"12",Xtom_NET_FAIL, nil] forKeys:[NSArray arrayWithObjects:@"error_code",@"success",@"msg", nil]];
        [_backTarget performSelector:_backSelector withObject:dic];
        [self closeConnect];
    }
}
