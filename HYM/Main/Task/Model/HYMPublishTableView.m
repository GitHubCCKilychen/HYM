...
//    }
    ...
    self.textfield = [[UITextField alloc] initWithFrame:CGRectMake(kScreenWitdth-130,6, 100, 30)];
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            self.textfield.frame = CGRectMake(kScreenWitdth-110, 6, 100, 30);
            [cell.contentView addSubview:self.textfield];
        }else if (indexPath.row == 1){
        
            label.text = @"个";
            [cell.contentView addSubview:label];
            self.textfield.frame = self.textfield.frame = CGRectMake(kScreenWitdth-130, 6, 100, 30);
            [cell.contentView addSubview:self.textfield];
            
        }else if (indexPath.row == 2){
        
            self.textfield.frame = self.textfield.frame = CGRectMake(kScreenWitdth/2-kScreenWitdth/4, 6, cell.contentView.frame.size.width - 80, 30);
            [cell.contentView addSubview:self.textfield];
        }else{
        
            self.textfield.frame = self.textfield.frame = CGRectMake(kScreenWitdth-110, 6, 100, 30);
